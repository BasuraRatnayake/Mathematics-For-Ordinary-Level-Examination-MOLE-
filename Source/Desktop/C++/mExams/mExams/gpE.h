...
namespace mExams {
	...
	/// Summary for gpE
	/// </summary>
	public ref class gpE : public System::Windows::Forms::Form
	{
	public:
		Core ^ core;
		gpE(void)
		{
			InitializeComponent();
			core= gcnew Core("Geometric Progressions", this, "gp");
			setAnswer();
		}
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(gpE::typeid));
			...
			this->Text = L"Exam";
			this->SizeChanged += gcnew System::EventHandler(this, &gpE::gpE_SizeChanged);
...
#pragma endregion
	private: System::Void gpE_SizeChanged(System::Object^  sender, System::EventArgs^  e) {
				 this->CenterToScreen();
			 }
