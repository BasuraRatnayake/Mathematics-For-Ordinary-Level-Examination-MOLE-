...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel7->Location = System::Drawing::Point(0, 941);
			...
			this->q10d->Size = System::Drawing::Size(182, 20);
			this->q10d->TabIndex = 11;
			this->q10d->TabStop = true;
			this->q10d->Text = L"D) 1 hour and 34 minutes";
			...
			this->q10b->Size = System::Drawing::Size(110, 20);
			this->q10b->TabIndex = 10;
			this->q10b->TabStop = true;
			this->q10b->Text = L"B) 16 minutes";
			...
			this->q10c->Size = System::Drawing::Size(110, 20);
			this->q10c->TabIndex = 9;
			this->q10c->TabStop = true;
			this->q10c->Text = L"C) 30 minutes";
			...
			this->q10a->Size = System::Drawing::Size(110, 20);
			this->q10a->TabIndex = 8;
			this->q10a->TabStop = true;
			this->q10a->Text = L"A) 10 minutes";
			...
			this->label20->Text = L"A fish-tank of 250l capacity is being fully filled with a horse at the rate of 15" 
				L"l per minute. The tank would be filled in,";
			...
			this->panel9->Location = System::Drawing::Point(0, 818);
			...
			this->q9d->Name = L"q9d";
			this->q9d->Size = System::Drawing::Size(126, 20);
			this->q9d->TabIndex = 11;
			this->q9d->TabStop = true;
			this->q9d->Text = L"D) 350 milliliters";
			...
			this->q9b->Name = L"q9b";
			this->q9b->Size = System::Drawing::Size(105, 20);
			this->q9b->TabIndex = 10;
			this->q9b->TabStop = true;
			this->q9b->Text = L"B) 4000 liters";
			...
			this->q9c->Name = L"q9c";
			this->q9c->Size = System::Drawing::Size(137, 20);
			this->q9c->TabIndex = 9;
			this->q9c->TabStop = true;
			this->q9c->Text = L"C) 3255 milliliters ";
			...
			this->q9a->Name = L"q9a";
			this->q9a->Size = System::Drawing::Size(112, 20);
			this->q9a->TabIndex = 8;
			this->q9a->TabStop = true;
			this->q9a->Text = L"A) 45000 liters";
			...
			this->label18->Text = L"A water storage tank of dimensions: length 3m, breadth 3m and height 5m is fully " 
				L"filled with water. The total water capacity of the tank is,";
			...
			this->panel10->Location = System::Drawing::Point(0, 718);
			...
			this->q8d->Name = L"q8d";
			this->q8d->Size = System::Drawing::Size(109, 20);
			this->q8d->TabIndex = 11;
			this->q8d->TabStop = true;
			this->q8d->Text = L"D) 1.350 liters";
			...
			this->q8b->Name = L"q8b";
			this->q8b->Size = System::Drawing::Size(105, 20);
			this->q8b->TabIndex = 10;
			this->q8b->TabStop = true;
			this->q8b->Text = L"B) 1001 liters";
			...
			this->q8c->Name = L"q8c";
			this->q8c->Size = System::Drawing::Size(105, 20);
			this->q8c->TabIndex = 9;
			this->q8c->TabStop = true;
			this->q8c->Text = L"C) 3500 liters";
			...
			this->q8a->Name = L"q8a";
			this->q8a->Size = System::Drawing::Size(102, 20);
			this->q8a->TabIndex = 8;
			this->q8a->TabStop = true;
			this->q8a->Text = L"A) 3.05 litres";
			...
			this->label16->Text = L"The amount of liters in 3.5m-3 is,";
			...
			this->panel11->Size = System::Drawing::Size(594, 118);
			...
			this->q7d->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q7d->Location = System::Drawing::Point(285, 82);
			this->q7d->Name = L"q7d";
			this->q7d->Size = System::Drawing::Size(94, 20);
			this->q7d->TabIndex = 11;
			this->q7d->TabStop = true;
			this->q7d->Text = L"D) 70kmh-1";
			...
			this->q7b->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q7b->Location = System::Drawing::Point(126, 83);
			this->q7b->Name = L"q7b";
			this->q7b->Size = System::Drawing::Size(93, 20);
			this->q7b->TabIndex = 10;
			this->q7b->TabStop = true;
			this->q7b->Text = L"B) 11kmh-1";
			...
			this->q7c->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q7c->Location = System::Drawing::Point(285, 62);
			this->q7c->Name = L"q7c";
			this->q7c->Size = System::Drawing::Size(98, 20);
			this->q7c->TabIndex = 9;
			this->q7c->TabStop = true;
			this->q7c->Text = L"C) 5.3kmh-1";
			...
			this->q7a->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q7a->Location = System::Drawing::Point(126, 63);
			this->q7a->Name = L"q7a";
			this->q7a->Size = System::Drawing::Size(87, 20);
			this->q7a->TabIndex = 8;
			this->q7a->TabStop = true;
			this->q7a->Text = L"A) 5kmh-1";
			...
			this->label14->Size = System::Drawing::Size(553, 46);
			...
			this->label15->Size = System::Drawing::Size(41, 118);
			...
			this->q6d->Name = L"q6d";
			this->q6d->Size = System::Drawing::Size(104, 20);
			this->q6d->TabIndex = 11;
			this->q6d->TabStop = true;
			this->q6d->Text = L"D) 5 seconds";
			...
			this->q6b->Name = L"q6b";
			this->q6b->Size = System::Drawing::Size(115, 20);
			this->q6b->TabIndex = 10;
			this->q6b->TabStop = true;
			this->q6b->Text = L"B) .06 seconds";
			...
			this->q6c->Name = L"q6c";
			this->q6c->Size = System::Drawing::Size(88, 20);
			this->q6c->TabIndex = 9;
			this->q6c->TabStop = true;
			this->q6c->Text = L"C) 2 hours";
			...
			this->q6a->Name = L"q6a";
			this->q6a->Size = System::Drawing::Size(110, 20);
			this->q6a->TabIndex = 8;
			this->q6a->TabStop = true;
			this->q6a->Text = L"A) 78 minutes";
			...
			this->label12->Text = L"A 60m long freight-train runs at 950ms-1. The time it takes to pass a signal-post" 
				L" is,";
			...
			this->q5d->Name = L"q5d";
			this->q5d->Size = System::Drawing::Size(98, 20);
			this->q5d->TabIndex = 11;
			this->q5d->TabStop = true;
			this->q5d->Text = L"D) 3.6kmh-1";
			...
			this->q5b->Name = L"q5b";
			this->q5b->Size = System::Drawing::Size(98, 20);
			this->q5b->TabIndex = 10;
			this->q5b->TabStop = true;
			this->q5b->Text = L"B) 5.5kmh-1";
			...
			this->q5c->Name = L"q5c";
			this->q5c->Size = System::Drawing::Size(94, 20);
			this->q5c->TabIndex = 9;
			this->q5c->TabStop = true;
			this->q5c->Text = L"C) 16kmh-1";
			...
			this->q5a->Name = L"q5a";
			this->q5a->Size = System::Drawing::Size(82, 20);
			this->q5a->TabIndex = 8;
			this->q5a->TabStop = true;
			this->q5a->Text = L"A) 4 ms-1";
			...
			this->label10->Text = L"If a canoe travelled the first 15km at a speed of 5km-1 and the next 20km at 3km-" 
				L"1, what’s the average speed of the canoe\?";
			...
			this->q4d->Name = L"q4d";
			this->q4d->Size = System::Drawing::Size(61, 20);
			this->q4d->TabIndex = 11;
			this->q4d->TabStop = true;
			this->q4d->Text = L"D) 4m";
			...
			this->q4b->Name = L"q4b";
			this->q4b->Size = System::Drawing::Size(72, 20);
			this->q4b->TabIndex = 10;
			this->q4b->TabStop = true;
			this->q4b->Text = L"B) 0.4m";
			...
			this->q4c->Name = L"q4c";
			this->q4c->Size = System::Drawing::Size(82, 20);
			this->q4c->TabIndex = 9;
			this->q4c->TabStop = true;
			this->q4c->Text = L"C) 480km";
			...
			this->q4a->Name = L"q4a";
			this->q4a->Size = System::Drawing::Size(79, 20);
			this->q4a->TabIndex = 8;
			this->q4a->TabStop = true;
			this->q4a->Text = L"A) 0.05m";
			...
			this->label7->Text = L"A snail travelled a certain distance with an accelerated speed of 0.1ms-1, in 4s." 
				L" Would this distance have been\?";
			...
			this->q3d->Name = L"q3d";
			this->q3d->Size = System::Drawing::Size(101, 20);
			this->q3d->TabIndex = 11;
			this->q3d->TabStop = true;
			this->q3d->Text = L"D) 780kmh-1";
			...
			this->q3b->Name = L"q3b";
			this->q3b->Size = System::Drawing::Size(94, 20);
			this->q3b->TabIndex = 10;
			this->q3b->TabStop = true;
			this->q3b->Text = L"B) 80kmh-1";
			...
			this->q3c->Name = L"q3c";
			this->q3c->Size = System::Drawing::Size(101, 20);
			this->q3c->TabIndex = 9;
			this->q3c->TabStop = true;
			this->q3c->Text = L"C) 288kmh-1";
			...
			this->q3a->Name = L"q3a";
			this->q3a->Size = System::Drawing::Size(94, 20);
			this->q3a->TabIndex = 8;
			this->q3a->TabStop = true;
			this->q3a->Text = L"A) 50kmh-1";
			...
			this->label5->Text = L"When converted to kmh-1, 80ms-1 would be,";
			...
			this->q2d->Name = L"q2d";
			this->q2d->Size = System::Drawing::Size(101, 20);
			this->q2d->TabIndex = 11;
			this->q2d->TabStop = true;
			this->q2d->Text = L"D) 200kmh-1";
			...
			this->q2b->Name = L"q2b";
			this->q2b->Size = System::Drawing::Size(85, 20);
			this->q2b->TabIndex = 10;
			this->q2b->TabStop = true;
			this->q2b->Text = L"B) 40ms-1";
			...
			this->q2c->Name = L"q2c";
			this->q2c->Size = System::Drawing::Size(87, 20);
			this->q2c->TabIndex = 9;
			this->q2c->TabStop = true;
			this->q2c->Text = L"C) 1kmh-1";
			...
			this->q2a->Name = L"q2a";
			this->q2a->Size = System::Drawing::Size(94, 20);
			this->q2a->TabIndex = 8;
			this->q2a->TabStop = true;
			this->q2a->Text = L"A) 20kmh-1";
			...
			this->label3->Text = L"A new Racing car takes 2 hour to travel 400km. If so, the average speed of the ca" 
				L"r would be,";
			...
			this->q1d->Name = L"q1d";
			this->q1d->Size = System::Drawing::Size(94, 20);
			this->q1d->TabIndex = 5;
			this->q1d->TabStop = true;
			this->q1d->Text = L"D) 10kmh-1";
			...
			this->q1b->Name = L"q1b";
			this->q1b->Size = System::Drawing::Size(87, 20);
			this->q1b->TabIndex = 4;
			this->q1b->TabStop = true;
			this->q1b->Text = L"B) 1kmh-1";
			...
			this->q1c->Name = L"q1c";
			this->q1c->Size = System::Drawing::Size(87, 20);
			this->q1c->TabIndex = 3;
			this->q1c->TabStop = true;
			this->q1c->Text = L"C) 2kmh-1";
			...
			this->q1a->Name = L"q1a";
			this->q1a->Size = System::Drawing::Size(105, 20);
			this->q1a->TabIndex = 2;
			this->q1a->TabStop = true;
			this->q1a->Text = L"A) 0.33kmh-1";
			...
			this->label2->Text = L"A three-wheeler takes 6 hour to go from Boutique A to Boutique B. If they are 2km" 
				L" apart, the speed of the three-wheeler would be,";
			...
			this->Text = L"speed";
			this->SizeChanged += gcnew System::EventHandler(this, &speed::speed_SizeChanged);
...
#pragma endregion
	private: System::Void speed_SizeChanged(System::Object^  sender, System::EventArgs^  e) {
				 this->CenterToScreen();
			 }
};
}
