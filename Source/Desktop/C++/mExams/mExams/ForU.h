...
namespace mExams {
	...
	/// Summary for ForU
	/// </summary>
	public ref class ForU : public System::Windows::Forms::Form
	{
	public:
		Core ^ core;
		ForU(void)
		{
			InitializeComponent();
			core= gcnew Core("Formulae", this,"fors");
			setAnswer();
		}
		void setAnswer(){
			 core->aSet[0]=q1b;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ForU::typeid));
			...
			this->q5d->Name = L"q5d";
			this->q5d->Size = System::Drawing::Size(74, 20);
			this->q5d->TabIndex = 11;
			this->q5d->TabStop = true;
			this->q5d->Text = L"D) 1,224";
			...
			this->q4d->Name = L"q4d";
			this->q4d->Size = System::Drawing::Size(49, 20);
			...
			this->q4b->Name = L"q4b";
			this->q4b->Size = System::Drawing::Size(63, 20);
			this->q4b->TabIndex = 10;
			this->q4b->TabStop = true;
			this->q4b->Text = L"B) 676";
			...
			this->q4c->Name = L"q4c";
			this->q4c->Size = System::Drawing::Size(56, 20);
			this->q4c->TabIndex = 9;
			this->q4c->TabStop = true;
			this->q4c->Text = L"C) 57";
			...
			this->q4a->Name = L"q4a";
			this->q4a->Size = System::Drawing::Size(63, 20);
			this->q4a->TabIndex = 8;
			this->q4a->TabStop = true;
			this->q4a->Text = L"A) 581";
			...
			this->label7->Text = L"When substituted with values, e=89 and f=45, what would z be in the formula: z=4e" 
				L"+5f\?";
			...
			this->q5b->Name = L"q5b";
			this->q5b->Size = System::Drawing::Size(81, 20);
			this->q5b->TabIndex = 10;
			this->q5b->TabStop = true;
			this->q5b->Text = L"B) 20,895";
			...
			this->q5c->Name = L"q5c";
			this->q5c->Size = System::Drawing::Size(80, 20);
			this->q5c->TabIndex = 9;
			this->q5c->TabStop = true;
			this->q5c->Text = L"C) 11,234";
			...
			this->q5a->Name = L"q5a";
			this->q5a->Size = System::Drawing::Size(81, 20);
			this->q5a->TabIndex = 8;
			this->q5a->TabStop = true;
			this->q5a->Text = L"A) 15,671";
			...
			this->label10->Text = L"Let a=67, b=34 and c=23 in the Formula: y=4a2+3b2-c2, what would y be\?";
			...
			this->q6d->Name = L"q6d";
			this->q6d->Size = System::Drawing::Size(81, 20);
			this->q6d->TabIndex = 11;
			this->q6d->TabStop = true;
			this->q6d->Text = L"D) 33,512";
			...
			this->q6b->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q6b->Location = System::Drawing::Point(126, 66);
			this->q6b->Name = L"q6b";
			this->q6b->Size = System::Drawing::Size(92, 20);
			this->q6b->TabIndex = 10;
			this->q6b->TabStop = true;
			this->q6b->Text = L"B) 5,789.23";
			...
			this->q6c->Name = L"q6c";
			this->q6c->Size = System::Drawing::Size(92, 20);
			this->q6c->TabIndex = 9;
			this->q6c->TabStop = true;
			this->q6c->Text = L"C) 1,197.65";
			...
			this->q6a->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q6a->Location = System::Drawing::Point(126, 46);
			this->q6a->Name = L"q6a";
			this->q6a->Size = System::Drawing::Size(92, 20);
			this->q6a->TabIndex = 8;
			this->q6a->TabStop = true;
			this->q6a->Text = L"A) 1,465.75";
			...
			this->panel5->Location = System::Drawing::Point(0, 237);
			...
			this->q3b->Name = L"q3b";
			this->q3b->Size = System::Drawing::Size(56, 20);
			this->q3b->TabIndex = 10;
			this->q3b->TabStop = true;
			this->q3b->Text = L"B) 40";
			...
			this->q3c->Name = L"q3c";
			this->q3c->Size = System::Drawing::Size(56, 20);
			this->q3c->TabIndex = 9;
			this->q3c->TabStop = true;
			this->q3c->Text = L"C) 71";
			...
			this->q3a->Name = L"q3a";
			this->q3a->Size = System::Drawing::Size(56, 20);
			this->q3a->TabIndex = 8;
			this->q3a->TabStop = true;
			this->q3a->Text = L"A) 22";
			...
			this->label5->Text = L"The formula: q= pc+ab, when substituted with a=5, b=10, c=3 and p=7, would make q" 
				L" to be,";
			...
			this->q1d->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q1d->Location = System::Drawing::Point(320, 69);
			this->q1d->Name = L"q1d";
			this->q1d->Size = System::Drawing::Size(38, 20);
			this->q1d->TabIndex = 5;
			...
			this->q1b->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q1b->Location = System::Drawing::Point(126, 70);
			this->q1b->Name = L"q1b";
			this->q1b->Size = System::Drawing::Size(38, 20);
			this->q1b->TabIndex = 4;
			...
			this->q1c->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q1c->Location = System::Drawing::Point(320, 45);
			this->q1c->Name = L"q1c";
			this->q1c->Size = System::Drawing::Size(38, 20);
			this->q1c->TabIndex = 3;
			...
			this->q1a->Name = L"q1a";
			this->q1a->Size = System::Drawing::Size(38, 20);
			this->q1a->TabIndex = 2;
			...
			this->q2d->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q2d->Location = System::Drawing::Point(284, 99);
			this->q2d->Name = L"q2d";
			this->q2d->Size = System::Drawing::Size(38, 20);
			...
			this->q2b->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q2b->Location = System::Drawing::Point(123, 101);
			this->q2b->Name = L"q2b";
			this->q2b->Size = System::Drawing::Size(38, 20);
			...
			this->q2c->Name = L"q2c";
			this->q2c->Size = System::Drawing::Size(38, 20);
			this->q2c->TabIndex = 9;
			...
			this->pictureBox5->Location = System::Drawing::Point(354, 72);
			this->pictureBox5->Name = L"pictureBox5";
			this->pictureBox5->Size = System::Drawing::Size(100, 18);
			...
			this->pictureBox4->Location = System::Drawing::Point(354, 48);
			this->pictureBox4->Name = L"pictureBox4";
			this->pictureBox4->Size = System::Drawing::Size(100, 18);
			...
			this->pictureBox3->Location = System::Drawing::Point(159, 70);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(100, 18);
			...
			this->pictureBox2->Location = System::Drawing::Point(159, 48);
			...
			this->pictureBox1->Location = System::Drawing::Point(296, 11);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(100, 18);
			...
			this->label2->Text = L"The correct way to make r the subject of the formula:                            " 
				L"        is, ";
			...
			this->q2a->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q2a->Location = System::Drawing::Point(124, 56);
			this->q2a->Name = L"q2a";
			this->q2a->Size = System::Drawing::Size(38, 20);
			this->q2a->TabIndex = 8;
			...
			this->label4->Size = System::Drawing::Size(41, 137);
			...
			this->panel4->Size = System::Drawing::Size(594, 137);
			...
			this->pictureBox10->Location = System::Drawing::Point(321, 88);
			this->pictureBox10->Name = L"pictureBox10";
			this->pictureBox10->Size = System::Drawing::Size(61, 37);
			...
			this->pictureBox9->Location = System::Drawing::Point(320, 48);
			this->pictureBox9->Name = L"pictureBox9";
			this->pictureBox9->Size = System::Drawing::Size(71, 18);
			...
			this->pictureBox8->Location = System::Drawing::Point(157, 102);
			this->pictureBox8->Name = L"pictureBox8";
			this->pictureBox8->Size = System::Drawing::Size(71, 18);
			...
			this->pictureBox7->Location = System::Drawing::Point(159, 48);
			...
			this->pictureBox6->Location = System::Drawing::Point(248, 10);
			this->pictureBox6->Name = L"pictureBox6";
			this->pictureBox6->Size = System::Drawing::Size(65, 18);
			...
			this->label3->Text = L"When c is made the subject of the formula:                      , it would become" 
				L", ";
			...
			this->label12->Text = L"After substituting g=57 and h=34, p=98 and r=32 in the formula: Q= gh2/pr, Q woul" 
				L"d be,";
			...
			this->panel7->Location = System::Drawing::Point(0, 960);
			...
			this->q10d->Size = System::Drawing::Size(72, 20);
			this->q10d->TabIndex = 11;
			this->q10d->TabStop = true;
			this->q10d->Text = L"D) c= 9f";
			...
			this->q10b->Size = System::Drawing::Size(106, 20);
			this->q10b->TabIndex = 10;
			this->q10b->TabStop = true;
			this->q10b->Text = L"B) c= 5f+5f-2f";
			...
			this->q10c->Size = System::Drawing::Size(106, 20);
			this->q10c->TabIndex = 9;
			this->q10c->TabStop = true;
			this->q10c->Text = L"C) c= 4f+7f-2f";
			...
			this->q10a->Size = System::Drawing::Size(102, 20);
			this->q10a->TabIndex = 8;
			this->q10a->TabStop = true;
			this->q10a->Text = L"A) c=4f+7t-2f";
			...
			this->panel9->Location = System::Drawing::Point(0, 837);
			...
			this->pictureBox12->Location = System::Drawing::Point(476, 9);
			this->pictureBox12->Name = L"pictureBox12";
			this->pictureBox12->Size = System::Drawing::Size(65, 18);
			...
			this->q9d->Name = L"q9d";
			this->q9d->Size = System::Drawing::Size(75, 20);
			this->q9d->TabIndex = 11;
			this->q9d->TabStop = true;
			this->q9d->Text = L"D) 27cm";
			...
			this->q9b->Name = L"q9b";
			this->q9b->Size = System::Drawing::Size(75, 20);
			this->q9b->TabIndex = 10;
			this->q9b->TabStop = true;
			this->q9b->Text = L"B) 76cm";
			...
			this->q9a->Name = L"q9a";
			this->q9a->Size = System::Drawing::Size(75, 20);
			this->q9a->TabIndex = 8;
			this->q9a->TabStop = true;
			this->q9a->Text = L"A) 56cm";
			...
			this->label18->Font = (gcnew System::Drawing::Font(L"Arial", 8.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			...
			this->label18->Text = L"Keheliya wants to find the circumference of his china-plate from the well-known f" 
				L"ormula:                      . If he found out that r=6cm and that π is 3.14, wh" 
				L"at is c\? \r\n";
			...
			this->panel10->Location = System::Drawing::Point(0, 737);
			...
			this->pictureBox11->Location = System::Drawing::Point(145, 17);
			this->pictureBox11->Name = L"pictureBox11";
			this->pictureBox11->Size = System::Drawing::Size(65, 18);
			...
			this->q8d->Name = L"q8d";
			this->q8d->Size = System::Drawing::Size(108, 20);
			this->q8d->TabIndex = 11;
			this->q8d->TabStop = true;
			this->q8d->Text = L"D) 12,872 cm³\r\n";
			...
			this->q8b->Name = L"q8b";
			this->q8b->Size = System::Drawing::Size(119, 20);
			this->q8b->TabIndex = 10;
			this->q8b->TabStop = true;
			this->q8b->Text = L"B) 3,052.08 cm³\r\n";
			...
			this->q8c->Name = L"q8c";
			this->q8c->Size = System::Drawing::Size(101, 20);
			this->q8c->TabIndex = 9;
			this->q8c->TabStop = true;
			this->q8c->Text = L"C) 9,567 cm³\r\n";
			...
			this->q8a->Name = L"q8a";
			this->q8a->Size = System::Drawing::Size(108, 20);
			this->q8a->TabIndex = 8;
			this->q8a->TabStop = true;
			this->q8a->Text = L"A) 51,263 cm³\r\n";
			...
			this->panel11->Location = System::Drawing::Point(0, 637);
			...
			this->q7d->Name = L"q7d";
			this->q7d->Size = System::Drawing::Size(92, 20);
			this->q7d->TabIndex = 11;
			this->q7d->TabStop = true;
			this->q7d->Text = L"D) 4,160.05";
			...
			this->q7b->Name = L"q7b";
			this->q7b->Size = System::Drawing::Size(74, 20);
			this->q7b->TabIndex = 10;
			this->q7b->TabStop = true;
			this->q7b->Text = L"B) 4,200";
			...
			this->q7c->Name = L"q7c";
			this->q7c->Size = System::Drawing::Size(92, 20);
			this->q7c->TabIndex = 9;
			this->q7c->TabStop = true;
			this->q7c->Text = L"C) 4,284.20";
			...
			this->q7a->Name = L"q7a";
			this->q7a->Size = System::Drawing::Size(85, 20);
			this->q7a->TabIndex = 8;
			this->q7a->TabStop = true;
			this->q7a->Text = L"A) 1,720.4";
			...
			this->label14->Text = L"Find d for the formula: d= n÷2 x (c+b), when n=44, b=56.2 and c=22,";
			...
			this->panel12->Location = System::Drawing::Point(0, 537);
			...
			this->panel8->Location = System::Drawing::Point(0, 437);
			...
			this->Text = L"ForU";
			this->SizeChanged += gcnew System::EventHandler(this, &ForU::ForU_SizeChanged);
...
#pragma endregion
	private: System::Void ForU_SizeChanged(System::Object^  sender, System::EventArgs^  e) {
				 this->CenterToScreen();
			 }
};
}
