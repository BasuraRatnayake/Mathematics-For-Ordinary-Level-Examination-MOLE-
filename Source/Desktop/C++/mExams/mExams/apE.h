...
namespace mExams {
	...
	/// Summary for apE
	/// </summary>
	public ref class apE : public System::Windows::Forms::Form
	{
	public:
		Core ^ core;
		apE(void)
		{
			InitializeComponent();
			core= gcnew Core("Arithmatic Progressions", this,"ap");
			setAnswer();
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(apE::typeid));
			...
			this->q10d->Size = System::Drawing::Size(74, 20);
			this->q10d->TabIndex = 11;
			this->q10d->TabStop = true;
			this->q10d->Text = L"D) 4,649";
			...
			this->q10b->Size = System::Drawing::Size(74, 20);
			this->q10b->TabIndex = 10;
			this->q10b->TabStop = true;
			this->q10b->Text = L"B) 3,713";
			...
			this->q10c->Size = System::Drawing::Size(74, 20);
			this->q10c->TabIndex = 9;
			this->q10c->TabStop = true;
			this->q10c->Text = L"C) 2,436";
			...
			this->q10a->Size = System::Drawing::Size(74, 20);
			this->q10a->TabIndex = 8;
			this->q10a->TabStop = true;
			this->q10a->Text = L"A) 2,652";
			...
			this->label20->Text = L"What’s the sum of the first 51 even numbers\?";
			...
			this->q9d->Name = L"q9d";
			this->q9d->Size = System::Drawing::Size(93, 20);
			this->q9d->TabIndex = 11;
			this->q9d->TabStop = true;
			this->q9d->Text = L"D) 78.89km";
			...
			this->q9b->Name = L"q9b";
			this->q9b->Size = System::Drawing::Size(95, 20);
			this->q9b->TabIndex = 10;
			this->q9b->TabStop = true;
			this->q9b->Text = L"B) 6.874Km";
			...
			this->q9c->Name = L"q9c";
			this->q9c->Size = System::Drawing::Size(82, 20);
			this->q9c->TabIndex = 9;
			this->q9c->TabStop = true;
			this->q9c->Text = L"C) 1248m";
			...
			this->q9a->Name = L"q9a";
			this->q9a->Size = System::Drawing::Size(95, 20);
			this->q9a->TabIndex = 8;
			this->q9a->TabStop = true;
			this->q9a->Text = L"A) 6.988Km";
			...
			this->q8d->Name = L"q8d";
			this->q8d->Size = System::Drawing::Size(99, 20);
			this->q8d->TabIndex = 11;
			this->q8d->TabStop = true;
			this->q8d->Text = L"D) 1,854,423";
			...
			this->q8b->Name = L"q8b";
			this->q8b->Size = System::Drawing::Size(99, 20);
			this->q8b->TabIndex = 10;
			this->q8b->TabStop = true;
			this->q8b->Text = L"B) 1,785,342";
			...
			this->q8c->Name = L"q8c";
			this->q8c->Size = System::Drawing::Size(88, 20);
			this->q8c->TabIndex = 9;
			this->q8c->TabStop = true;
			this->q8c->Text = L"C) 109,620";
			...
			this->q8a->Name = L"q8a";
			this->q8a->Size = System::Drawing::Size(74, 20);
			this->q8a->TabIndex = 8;
			this->q8a->TabStop = true;
			this->q8a->Text = L"A) 1,832";
			...
			this->label16->Text = L"The sum of the integers from 58 to 1,890 is, ";
			...
			this->q7b->Name = L"q7b";
			this->q7b->Size = System::Drawing::Size(56, 20);
			this->q7b->TabIndex = 10;
			this->q7b->TabStop = true;
			this->q7b->Text = L"B) 18";
			...
			this->q7c->Name = L"q7c";
			this->q7c->Size = System::Drawing::Size(56, 20);
			this->q7c->TabIndex = 9;
			this->q7c->TabStop = true;
			this->q7c->Text = L"C) 36";
			...
			this->q7a->Name = L"q7a";
			this->q7a->Size = System::Drawing::Size(56, 20);
			this->q7a->TabIndex = 8;
			this->q7a->TabStop = true;
			this->q7a->Text = L"A) 22";
			...
			this->label14->Text = L"What is the sum of the first 4 terms of a 4 term progression with a=3 and l=15\?";
			...
			this->q6d->Name = L"q6d";
			this->q6d->Size = System::Drawing::Size(132, 20);
			this->q6d->TabIndex = 11;
			this->q6d->TabStop = true;
			this->q6d->Text = L"D) 41,45.5,50.4,52";
			...
			this->q6b->Name = L"q6b";
			this->q6b->Size = System::Drawing::Size(110, 20);
			this->q6b->TabIndex = 10;
			this->q6b->TabStop = true;
			this->q6b->Text = L"B) 41,43,49,52";
			...
			this->q6c->Name = L"q6c";
			this->q6c->Size = System::Drawing::Size(132, 20);
			this->q6c->TabIndex = 9;
			this->q6c->TabStop = true;
			this->q6c->Text = L"C) 41,44.6,48.2,52";
			...
			this->label12->Text = L"If inserted 2 arithmetic means to a progression between 41 and 52, it would becom" 
				L"e,";
			...
			this->q5d->Name = L"q5d";
			this->q5d->Size = System::Drawing::Size(68, 20);
			this->q5d->TabIndex = 11;
			this->q5d->TabStop = true;
			this->q5d->Text = L"D) 8.5x";
			...
			this->q5b->Name = L"q5b";
			this->q5b->Size = System::Drawing::Size(68, 20);
			this->q5b->TabIndex = 10;
			this->q5b->TabStop = true;
			this->q5b->Text = L"B) 5.2x";
			...
			this->q5c->Name = L"q5c";
			this->q5c->Size = System::Drawing::Size(57, 20);
			this->q5c->TabIndex = 9;
			this->q5c->TabStop = true;
			this->q5c->Text = L"C) 6x";
			...
			this->q5a->Name = L"q5a";
			this->q5a->Size = System::Drawing::Size(50, 20);
			this->q5a->TabIndex = 8;
			...
			this->label10->Text = L"What’s the arithmetic mean of 5x,…,12x\?";
			...
			this->q4d->Name = L"q4d";
			this->q4d->Size = System::Drawing::Size(56, 20);
			this->q4d->TabIndex = 11;
			this->q4d->TabStop = true;
			this->q4d->Text = L"D) 12";
			...
			this->q4b->Name = L"q4b";
			this->q4b->Size = System::Drawing::Size(60, 20);
			this->q4b->TabIndex = 10;
			this->q4b->TabStop = true;
			this->q4b->Text = L"B) -38";
			...
			this->q4c->Name = L"q4c";
			this->q4c->Size = System::Drawing::Size(60, 20);
			this->q4c->TabIndex = 9;
			this->q4c->TabStop = true;
			this->q4c->Text = L"C) -56";
			...
			this->q4a->Name = L"q4a";
			this->q4a->Size = System::Drawing::Size(56, 20);
			this->q4a->TabIndex = 8;
			this->q4a->TabStop = true;
			this->q4a->Text = L"A) 45";
			...
			this->label7->Text = L"The arithmetic mean of 56 and -94 is, ";
			...
			this->q3d->Name = L"q3d";
			this->q3d->Size = System::Drawing::Size(80, 20);
			this->q3d->TabIndex = 11;
			this->q3d->TabStop = true;
			this->q3d->Text = L"D) 94,112";
			...
			this->q3b->Name = L"q3b";
			this->q3b->Size = System::Drawing::Size(88, 20);
			this->q3b->TabIndex = 10;
			this->q3b->TabStop = true;
			this->q3b->Text = L"B) -112,-94";
			...
			this->q3c->Name = L"q3c";
			this->q3c->Size = System::Drawing::Size(82, 20);
			this->q3c->TabIndex = 9;
			this->q3c->TabStop = true;
			this->q3c->Text = L"C) -67,-85";
			...
			this->q3a->Name = L"q3a";
			this->q3a->Size = System::Drawing::Size(74, 20);
			this->q3a->TabIndex = 8;
			this->q3a->TabStop = true;
			this->q3a->Text = L"A) 67,85";
			...
			this->label5->Text = L"An arithmetic progression has a common difference of 4.5 and its 7th term is -85," 
				L" what are its first and 3rd terms\?";
			...
			this->q2d->Name = L"q2d";
			this->q2d->Size = System::Drawing::Size(103, 20);
			this->q2d->TabIndex = 11;
			this->q2d->TabStop = true;
			this->q2d->Text = L"D) 7,12,17,22";
			...
			this->q2b->Name = L"q2b";
			this->q2b->Size = System::Drawing::Size(95, 20);
			this->q2b->TabIndex = 10;
			this->q2b->TabStop = true;
			this->q2b->Text = L"B) 7,9,11,13";
			...
			this->q2c->Name = L"q2c";
			this->q2c->Size = System::Drawing::Size(103, 20);
			this->q2c->TabIndex = 9;
			this->q2c->TabStop = true;
			this->q2c->Text = L"C) 7,14,21,28";
			...
			this->q2a->Name = L"q2a";
			this->q2a->Size = System::Drawing::Size(89, 20);
			this->q2a->TabIndex = 8;
			this->q2a->TabStop = true;
			this->q2a->Text = L"A) 4,6,8,10";
			...
			this->label3->Text = L"The first 4 values of the progression having a=7 and d=2 is, ";
			...
			this->q1d->Name = L"q1d";
			this->q1d->Size = System::Drawing::Size(56, 20);
			this->q1d->TabIndex = 5;
			this->q1d->TabStop = true;
			this->q1d->Text = L"D) 20";
			...
			this->q1a->Name = L"q1a";
			this->q1a->Size = System::Drawing::Size(56, 20);
			this->q1a->TabIndex = 2;
			this->q1a->TabStop = true;
			this->q1a->Text = L"A) 45";
			...
			this->label2->Text = L"Find the 6th term of the arithmetic progression: 5,8,11,…\r\n";
			...
			this->Text = L"Arithmatic Progression Examination";
			this->SizeChanged += gcnew System::EventHandler(this, &apE::apE_SizeChanged);
...
private: System::Void apE_SizeChanged(System::Object^  sender, System::EventArgs^  e) {
			 this->CenterToScreen();
		 }
};
}
