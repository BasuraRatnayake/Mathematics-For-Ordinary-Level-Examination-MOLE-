...
namespace mExams {
	...
	/// Summary for binoE
	/// </summary>
	public ref class binoE : public System::Windows::Forms::Form
	{
	public:
		...
		{
			InitializeComponent();
			core= gcnew Core("Binomial Expressions", this, "be");
			setAnswer();
		}
		Core ^ core;
		//Set Correct Answers from Here
		void setAnswer(){
			 core->aSet[0]=q1a;
			 core->aSet[1]=q2a;
			 core->aSet[2]=q3a;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(binoE::typeid));
			...
			this->panel7->Location = System::Drawing::Point(0, 900);
			...
			this->q10d->Size = System::Drawing::Size(134, 20);
			this->q10d->TabIndex = 11;
			this->q10d->TabStop = true;
			this->q10d->Text = L"D (asvdhkvashdv)";
			...
			this->q10b->Size = System::Drawing::Size(142, 20);
			this->q10b->TabIndex = 10;
			this->q10b->TabStop = true;
			this->q10b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q10c->Size = System::Drawing::Size(143, 20);
			this->q10c->TabIndex = 9;
			this->q10c->TabStop = true;
			this->q10c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q10a->Size = System::Drawing::Size(98, 20);
			this->q10a->TabIndex = 8;
			this->q10a->TabStop = true;
			this->q10a->Text = L"A (asdhgas)";
			...
			this->label20->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->panel9->Size = System::Drawing::Size(594, 100);
			...
			this->q9d->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q9d->Location = System::Drawing::Point(285, 65);
			this->q9d->Name = L"q9d";
			this->q9d->Size = System::Drawing::Size(134, 20);
			this->q9d->TabIndex = 11;
			this->q9d->TabStop = true;
			this->q9d->Text = L"D (asvdhkvashdv)";
			...
			this->q9b->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q9b->Location = System::Drawing::Point(126, 66);
			this->q9b->Name = L"q9b";
			this->q9b->Size = System::Drawing::Size(142, 20);
			this->q9b->TabIndex = 10;
			this->q9b->TabStop = true;
			this->q9b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q9c->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q9c->Location = System::Drawing::Point(285, 45);
			this->q9c->Name = L"q9c";
			this->q9c->Size = System::Drawing::Size(143, 20);
			this->q9c->TabIndex = 9;
			this->q9c->TabStop = true;
			this->q9c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q9a->Font = (gcnew System::Drawing::Font(L"Arial", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->q9a->Location = System::Drawing::Point(126, 46);
			this->q9a->Name = L"q9a";
			this->q9a->Size = System::Drawing::Size(98, 20);
			this->q9a->TabIndex = 8;
			this->q9a->TabStop = true;
			this->q9a->Text = L"A (asdhgas)";
			...
			this->label18->Size = System::Drawing::Size(553, 37);
			this->label18->TabIndex = 7;
			this->label18->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->label19->Size = System::Drawing::Size(41, 100);
			...
			this->q8d->Name = L"q8d";
			this->q8d->Size = System::Drawing::Size(134, 20);
			this->q8d->TabIndex = 11;
			this->q8d->TabStop = true;
			this->q8d->Text = L"D (asvdhkvashdv)";
			...
			this->q8b->Name = L"q8b";
			this->q8b->Size = System::Drawing::Size(142, 20);
			this->q8b->TabIndex = 10;
			this->q8b->TabStop = true;
			this->q8b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q8c->Name = L"q8c";
			this->q8c->Size = System::Drawing::Size(143, 20);
			this->q8c->TabIndex = 9;
			this->q8c->TabStop = true;
			this->q8c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q8a->Name = L"q8a";
			this->q8a->Size = System::Drawing::Size(98, 20);
			this->q8a->TabIndex = 8;
			this->q8a->TabStop = true;
			this->q8a->Text = L"A (asdhgas)";
			...
			this->label16->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q7d->Name = L"q7d";
			this->q7d->Size = System::Drawing::Size(134, 20);
			this->q7d->TabIndex = 11;
			this->q7d->TabStop = true;
			this->q7d->Text = L"D (asvdhkvashdv)";
			...
			this->q7b->Name = L"q7b";
			this->q7b->Size = System::Drawing::Size(142, 20);
			this->q7b->TabIndex = 10;
			this->q7b->TabStop = true;
			this->q7b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q7c->Name = L"q7c";
			this->q7c->Size = System::Drawing::Size(143, 20);
			this->q7c->TabIndex = 9;
			this->q7c->TabStop = true;
			this->q7c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q7a->Name = L"q7a";
			this->q7a->Size = System::Drawing::Size(98, 20);
			this->q7a->TabIndex = 8;
			this->q7a->TabStop = true;
			this->q7a->Text = L"A (asdhgas)";
			...
			this->label14->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q6d->Name = L"q6d";
			this->q6d->Size = System::Drawing::Size(134, 20);
			this->q6d->TabIndex = 11;
			this->q6d->TabStop = true;
			this->q6d->Text = L"D (asvdhkvashdv)";
			...
			this->q6b->Name = L"q6b";
			this->q6b->Size = System::Drawing::Size(142, 20);
			this->q6b->TabIndex = 10;
			this->q6b->TabStop = true;
			this->q6b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q6c->Name = L"q6c";
			this->q6c->Size = System::Drawing::Size(143, 20);
			this->q6c->TabIndex = 9;
			this->q6c->TabStop = true;
			this->q6c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q6a->Name = L"q6a";
			this->q6a->Size = System::Drawing::Size(98, 20);
			this->q6a->TabIndex = 8;
			this->q6a->TabStop = true;
			this->q6a->Text = L"A (asdhgas)";
			...
			this->label12->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q5d->Name = L"q5d";
			this->q5d->Size = System::Drawing::Size(134, 20);
			this->q5d->TabIndex = 11;
			this->q5d->TabStop = true;
			this->q5d->Text = L"D (asvdhkvashdv)";
			...
			this->q5b->Name = L"q5b";
			this->q5b->Size = System::Drawing::Size(142, 20);
			this->q5b->TabIndex = 10;
			this->q5b->TabStop = true;
			this->q5b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q5c->Name = L"q5c";
			this->q5c->Size = System::Drawing::Size(143, 20);
			this->q5c->TabIndex = 9;
			this->q5c->TabStop = true;
			this->q5c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q5a->Name = L"q5a";
			this->q5a->Size = System::Drawing::Size(98, 20);
			this->q5a->TabIndex = 8;
			this->q5a->TabStop = true;
			this->q5a->Text = L"A (asdhgas)";
			...
			this->label10->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q4d->Name = L"q4d";
			this->q4d->Size = System::Drawing::Size(134, 20);
			this->q4d->TabIndex = 11;
			this->q4d->TabStop = true;
			this->q4d->Text = L"D (asvdhkvashdv)";
			...
			this->q4b->Name = L"q4b";
			this->q4b->Size = System::Drawing::Size(142, 20);
			this->q4b->TabIndex = 10;
			this->q4b->TabStop = true;
			this->q4b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q4c->Name = L"q4c";
			this->q4c->Size = System::Drawing::Size(143, 20);
			this->q4c->TabIndex = 9;
			this->q4c->TabStop = true;
			this->q4c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q4a->Name = L"q4a";
			this->q4a->Size = System::Drawing::Size(98, 20);
			this->q4a->TabIndex = 8;
			this->q4a->TabStop = true;
			this->q4a->Text = L"A (asdhgas)";
			...
			this->label7->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q3d->Name = L"q3d";
			this->q3d->Size = System::Drawing::Size(134, 20);
			this->q3d->TabIndex = 11;
			this->q3d->TabStop = true;
			this->q3d->Text = L"D (asvdhkvashdv)";
			...
			this->q3b->Name = L"q3b";
			this->q3b->Size = System::Drawing::Size(142, 20);
			this->q3b->TabIndex = 10;
			this->q3b->TabStop = true;
			this->q3b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q3c->Name = L"q3c";
			this->q3c->Size = System::Drawing::Size(143, 20);
			this->q3c->TabIndex = 9;
			this->q3c->TabStop = true;
			this->q3c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q3a->Name = L"q3a";
			this->q3a->Size = System::Drawing::Size(98, 20);
			this->q3a->TabIndex = 8;
			this->q3a->TabStop = true;
			this->q3a->Text = L"A (asdhgas)";
			...
			this->label5->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q2d->Name = L"q2d";
			this->q2d->Size = System::Drawing::Size(134, 20);
			this->q2d->TabIndex = 11;
			this->q2d->TabStop = true;
			this->q2d->Text = L"D (asvdhkvashdv)";
			...
			this->q2b->Name = L"q2b";
			this->q2b->Size = System::Drawing::Size(142, 20);
			this->q2b->TabIndex = 10;
			this->q2b->TabStop = true;
			this->q2b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q2c->Name = L"q2c";
			this->q2c->Size = System::Drawing::Size(143, 20);
			this->q2c->TabIndex = 9;
			this->q2c->TabStop = true;
			this->q2c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q2a->Name = L"q2a";
			this->q2a->Size = System::Drawing::Size(98, 20);
			this->q2a->TabIndex = 8;
			this->q2a->TabStop = true;
			this->q2a->Text = L"A (asdhgas)";
			...
			this->label3->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->q1d->Name = L"q1d";
			this->q1d->Size = System::Drawing::Size(134, 20);
			this->q1d->TabIndex = 5;
			this->q1d->TabStop = true;
			this->q1d->Text = L"D (asvdhkvashdv)";
			...
			this->q1b->Name = L"q1b";
			this->q1b->Size = System::Drawing::Size(142, 20);
			this->q1b->TabIndex = 4;
			this->q1b->TabStop = true;
			this->q1b->Text = L"B (ahvsdhvasdasd)";
			...
			this->q1c->Name = L"q1c";
			this->q1c->Size = System::Drawing::Size(143, 20);
			this->q1c->TabIndex = 3;
			this->q1c->TabStop = true;
			this->q1c->Text = L"C (avshdvahjvsdjh)";
			...
			this->q1a->Name = L"q1a";
			this->q1a->Size = System::Drawing::Size(98, 20);
			this->q1a->TabIndex = 2;
			this->q1a->TabStop = true;
			this->q1a->Text = L"A (asdhgas)";
			...
			this->label2->Text = L"Question 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQuestion 1 showsQ" 
				L"uestion 1 showsQuestion 1 shows";
			...
			this->Text = L"binoE";
			this->SizeChanged += gcnew System::EventHandler(this, &binoE::binoE_SizeChanged);
...
#pragma endregion
	private: System::Void binoE_SizeChanged(System::Object^  sender, System::EventArgs^  e) {
				 this->CenterToScreen();
			 }
};
}
